      ...
      <>
        ...
        <DialogActions>
          ...
          <Button
            color="warning"
            onClick={() => {
              // this option would only be presented in an edit case when this is non-null
              // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
              dispatch(mealActions.yesDelete(editId!));
            }}>
            Yes
          </Button>
        </DialogActions>
    ...
    return (
      <form onSubmit={formik.handleSubmit}>
        ...
        <DialogContent sx={{ pt: '8px !important' }}>
          ...
          <FormControl
            ...
            <Select
              ...
              {mealListTypeDate.map((mt) => (
                <MenuItem key={mt.meal} value={mt.meal}>
                  {mt.title}
                </MenuItem>
              ))}
            </Select>
          ...
          <FormControl
            ...
            <Select
              ...
              onChange={formik.handleChange}>
              {(formik.values.brand
                ? flavorsForBrand(formik.values.brand)
                : []
              ).map((f) => (
        ...
        <DialogActions>
          ...
          <Button
            type="button"
            onClick={() => dispatch(mealActions.cancelEditMeal())}>
            Cancel
          </Button>
