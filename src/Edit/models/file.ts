...
export function fromSaveFile(file: SaveFileV1): {brands: BrandListState, meals: MealListState} {
  return {
    brands: file.brands.reduce((dict, brand) => {
      ...
      return dict;
    }, {} as BrandListState), meals: file.meals.reduce((dict, meal) => {
      dict[meal.id] = meal;
      return dict
    }, {} as MealListState)
  }
...
export function toSaveFile(brands: BrandListState, meals: MealListState): SaveFileV1 {
  return {
    version: 1,
